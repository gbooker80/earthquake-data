//  light Layer
var lightMap = L.tileLayer('https://api.mapbox.com/styles/v1/mapbox/light-v9/tiles/256/{z}/{x}/{y}?access_token=pk.eyJ1IjoiZ2VvZmZyZXlib29rZXI4MCIsImEiOiJjamU2aHkxaDkwMGZsMnhtenR4MjEzYXhwIn0.k4WgBrIU34Dcf55ZI_7gdQ',
    {maxZoom: 18});

// outdoors layer
var outdoorsMap = L.tileLayer('https://api.mapbox.com/styles/v1/mapbox/outdoors-v9/tiles/256/{z}/{x}/{y}?access_token=pk.eyJ1IjoiZ2VvZmZyZXlib29rZXI4MCIsImEiOiJjamU2aHkxaDkwMGZsMnhtenR4MjEzYXhwIn0.k4WgBrIU34Dcf55ZI_7gdQ')

//  satelite tile layer
var satelliteMap = L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token={accessToken}', {
    maxZoom: 18,
    id: 'mapbox.satellite',
    accessToken: 'pk.eyJ1IjoiZ2VvZmZyZXlib29rZXI4MCIsImEiOiJjamU2aHkxaDkwMGZsMnhtenR4MjEzYXhwIn0.k4WgBrIU34Dcf55ZI_7gdQ'
});
...
legend.onAdd = function (mymap) {
    ...
    // Loop through density intervals to create a label with a colored square for each interval
